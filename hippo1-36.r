...
H20f <- subset(H20, subset = nFeature_RNA > 200 & nFeature_RNA < 6000 & percent.mt < 5)
...
# head(colnames(merged.H131415))
# tail(colnames(merged.H131415))
# unique(sapply(X = strsplit(colnames(merged.H131415), split = "_"), FUN = "[", 1))
# table(merged.H131415$orig.ident)
...
for (i in 1:length(merged.H131415.list)) {
